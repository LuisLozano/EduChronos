...
- L753 — ### Sesión 159 — O-curso (H4), C-duplicado-guarda: **EL CURSO SE DUPLICA Y EL ANTERIOR QUEDA EN SOLO LECTURA, EN EL BACKEND: `O-curso` EN 2 DE 9.** Antes, decisión de mapa: la disponibilidad del profesorado entra en el paso 2 de §1 y H2 se reabre con `O-disponibilidad`, registrado y no abierto.
...
- L3181 — ### Deuda consciente CERRADA (histórico)
- L3383 — ### Notas técnicas validadas en Fase 0
- L3396 — ### Notas técnicas validadas en Fase 6
- L3441 — ### Notas técnicas validadas en Fase 9
- L3450 — ### Notas técnicas validadas en Fase 11
- L3590 — ### Por qué OR-Tools sobre Timefold (no reabrir)
- L3599 — ### Hallazgos del análisis de PDFs (datos reales del centro)
- L3626 — ### Registro detallado de sesiones S10–S31
- L3635 — ## Señales globales de alerta
...
### Sesión 159 — O-curso (H4), C-duplicado-guarda: **EL CURSO SE DUPLICA Y EL ANTERIOR QUEDA EN SOLO LECTURA, EN EL BACKEND: `O-curso` EN 2 DE 9.** Antes, decisión de mapa: la disponibilidad del profesorado entra en el paso 2 de §1 y H2 se reabre con `O-disponibilidad`, registrado y no abierto.
...
Última sesión registrada (previa): Sesión 158 — O-curso (H4), C-alcance-curso: **H4 ABRE SU SEGUNDO OBJETIVO, `O-curso`, CON EL CRITERIO ESCRITO SOBRE MEDICIÓN: 0 DE 9.** Duplicar curso deja de ser un texto de fase y pasa a nueve condiciones verificables; se descarta el selector de curso al iniciar, y la ejecución de la cadena entera de §1 sale a un objetivo propio.
