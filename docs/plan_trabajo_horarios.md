...
- L699 — ### Sesión 140 — O-particiones (H2): **EL ALTA REPLICADA YA SE PUEDE DESHACER, Y AL PROBARLA SOBRE EL CENTRO REAL SE DESCUBRE QUE LA CONDICIÓN (1) NO ESTABA CUMPLIDA.** Dos Cambios de hecho en uno: `C-alta-reversible` construido, y el defecto de S139 que el M4 destapó, reparado dentro del mismo Cambio. Primer ciclo alta→deshacer ejecutado sobre COPIA del centro completo, con dump idéntico. 302 tests en app (293 → 300 → 302). Ningún fichero de `solver/` ni de `app/frontend/` tocado.
- L768 — ### Bloques de Fase 2
- L776 — ### Bloques de Fase 5
- L799 — ### Bloques de Fase 6
- L844 — ### Bloques de Fase 8
- L1053 — ### Fases completadas
- L1157 — ### Cierre del modelo — Sesión 8
- L1205 — ### Decisiones permanentes (no reabrir sin razón de peso)
- L1251 — ### Método de trabajo (procedimiento vigente)
- L1284 — ### Deuda consciente VIVA
- L2990 — ### Deuda consciente CERRADA (histórico)
- L3088 — ### Notas técnicas validadas en Fase 0
- L3098 — ### Notas técnicas validadas en Fase 6
- L3132 — ### Por qué OR-Tools sobre Timefold (no reabrir)
- L3141 — ### Hallazgos del análisis de PDFs (datos reales del centro)
- L3168 — ### Registro detallado de sesiones S10–S31
- L3177 — ## Señales globales de alerta
