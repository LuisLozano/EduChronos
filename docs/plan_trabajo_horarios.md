...
- L699 — ### Sesión 139 — O-particiones (H2): **EL ALTA REPLICADA EXISTE EN SERVIDOR. Un grupo nuevo hereda los bloques de un hermano por un sub-recurso propio, con CERO decisiones en los 29 bloques replicados y exactamente N en los 10 de reparto.** Primera sesión de Desarrollo y primer fichero de `app/src` tocado desde S132. **El «Terminado cuando» del objetivo se ESTRECHA a los bloques**, tras medir que clonar dentro de una actividad de plaza única no replica al grupo: lo FUNDE con su hermano. Cuatro modificaciones al código existente, tres ficheros nuevos, 11 tests y 10 mutaciones. Nace y se paga `D-javadoc-plazas-caducado`. Ningún fichero de `solver/` ni de `app/frontend/` tocado.
- L767 — ### Bloques de Fase 2
- L775 — ### Bloques de Fase 5
- L798 — ### Bloques de Fase 6
- L843 — ### Bloques de Fase 8
- L1052 — ### Fases completadas
- L1156 — ### Cierre del modelo — Sesión 8
- L1204 — ### Decisiones permanentes (no reabrir sin razón de peso)
- L1250 — ### Método de trabajo (procedimiento vigente)
- L1283 — ### Deuda consciente VIVA
- L2989 — ### Deuda consciente CERRADA (histórico)
- L3087 — ### Notas técnicas validadas en Fase 0
- L3097 — ### Notas técnicas validadas en Fase 6
- L3131 — ### Por qué OR-Tools sobre Timefold (no reabrir)
- L3140 — ### Hallazgos del análisis de PDFs (datos reales del centro)
- L3167 — ### Registro detallado de sesiones S10–S31
- L3176 — ## Señales globales de alerta
