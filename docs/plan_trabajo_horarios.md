...
- L699 — ### Sesión 137 — O-demo (H2): **EL CENTRO ENTREGA LA LISTA OFICIAL DE TUTORES Y O-DEMO CIERRA. Las TRES patas del criterio 5 de Fase 8 quedan demostradas a escala real: centro completo por las vías legítimas del producto, horario válido sobre él y ningún dato identificativo falso en pantalla.** La corrección entra como PAR INDIVISIBLE —7 tutorías reescritas y `requiereTutor` a 0 en las 6 actividades de bloque— por el catálogo, y la base se rehace desde vacío. Se cierran `D-tutores-bachillerato` y `D-hallazgo-E-refutado`; nacen `D-meta-invariantes-a-mano` y `D-catalogo-candidatos-huerfano`. Tres commits, ni un fichero de `app/` ni de `solver/` tocado.
- L771 — ### Bloques de Fase 2
- L779 — ### Bloques de Fase 5
- L802 — ### Bloques de Fase 6
- L847 — ### Bloques de Fase 8
- L1056 — ### Fases completadas
- L1160 — ### Cierre del modelo — Sesión 8
- L1208 — ### Decisiones permanentes (no reabrir sin razón de peso)
- L1254 — ### Método de trabajo (procedimiento vigente)
- L1287 — ### Deuda consciente VIVA
- L2961 — ### Deuda consciente CERRADA (histórico)
- L3059 — ### Notas técnicas validadas en Fase 0
- L3069 — ### Notas técnicas validadas en Fase 6
- L3103 — ### Por qué OR-Tools sobre Timefold (no reabrir)
- L3112 — ### Hallazgos del análisis de PDFs (datos reales del centro)
- L3139 — ### Registro detallado de sesiones S10–S31
- L3148 — ## Señales globales de alerta
...
El plan conserva ahora S136 (degradada a formato compacto) y S137 como única cabecera H3 viva. (Esta frase
