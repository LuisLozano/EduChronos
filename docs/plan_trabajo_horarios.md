...
- L718 — ### Sesión 143 — O-ajuste-cierre (H1), C-mover-sesion-backend: **EL ENDPOINT DE RECOLOCACIÓN EXISTE, ESTÁ MEDIDO Y ES CORRECTO, Y SOBRE EL CENTRO REAL NO PUEDE PRODUCIR NI UN SOLO MOVIMIENTO VÁLIDO.** Los 28 grupos están a 30/30 tramos y no hay plazas sin subgrupo: cualquier instancia, en cualquiera de los 29 destinos, choca con lo que su grupo ya tiene ahí. 59 PUT sobre el centro completo, 58 rechazos y una idempotencia; el fichero de la base queda byte a byte idéntico al de partida. app 303 -> 317.
- L790 — ### Bloques de Fase 2
- L798 — ### Bloques de Fase 5
- L821 — ### Bloques de Fase 6
- L866 — ### Bloques de Fase 8
- L1075 — ### Fases completadas
- L1179 — ### Cierre del modelo — Sesión 8
- L1227 — ### Decisiones permanentes (no reabrir sin razón de peso)
- L1273 — ### Método de trabajo (procedimiento vigente)
- L1306 — ### Deuda consciente VIVA
- L3028 — ### Deuda consciente CERRADA (histórico)
- L3126 — ### Notas técnicas validadas en Fase 0
- L3136 — ### Notas técnicas validadas en Fase 6
- L3170 — ### Por qué OR-Tools sobre Timefold (no reabrir)
- L3179 — ### Hallazgos del análisis de PDFs (datos reales del centro)
- L3206 — ### Registro detallado de sesiones S10–S31
- L3215 — ## Señales globales de alerta
