...
- L753 — ### Sesión 162 — O-curso (H4), C-e2e-curso: **EL E2E DUPLICA, CAMBIA DE CURSO Y VE RECHAZADA UNA ESCRITURA EN EL ARCHIVADO, Y LA SUITE PASA A CORRER EN SERIE CON CARPETA DE DATOS PROPIA: `O-curso` EN 8 DE 9.**
- L822 — ### Bloques de Fase 2
- L830 — ### Bloques de Fase 5
- L853 — ### Bloques de Fase 6
- L898 — ### Bloques de Fase 8
- L1110 — ### Fases completadas
- L1214 — ### Cierre del modelo — Sesión 8
...
- L3162 — ### Deuda consciente CERRADA (histórico)
- L3419 — ### Notas técnicas validadas en Fase 0
- L3432 — ### Notas técnicas validadas en Fase 6
- L3477 — ### Notas técnicas validadas en Fase 9
- L3486 — ### Notas técnicas validadas en Fase 11
- L3626 — ### Por qué OR-Tools sobre Timefold (no reabrir)
- L3635 — ### Hallazgos del análisis de PDFs (datos reales del centro)
- L3662 — ### Registro detallado de sesiones S10–S31
- L3671 — ## Señales globales de alerta
...
### Sesión 162 — O-curso (H4), C-e2e-curso: **EL E2E DUPLICA, CAMBIA DE CURSO Y VE RECHAZADA UNA ESCRITURA EN EL ARCHIVADO, Y LA SUITE PASA A CORRER EN SERIE CON CARPETA DE DATOS PROPIA: `O-curso` EN 8 DE 9.**
...
Última sesión registrada (previa): Sesión 161 — O-curso (H4), C-horario-vigente: **«HORARIO» LLEVA AL ÚLTIMO HORARIO DEL CURSO ABIERTO, TAMBIÉN EN UNO ARCHIVADO, Y SUS CUATRO DESCARGAS PASAN EL ORÁCULO: `O-curso` EN 7 DE 9.**
...
- **D-curso-sin-borrado** (S160, VIVA, MEJORA FUTURA, no bloqueante, sede `O-curso`) — UN CURSO NO SE PUEDE
