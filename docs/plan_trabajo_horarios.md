...
- L718 — ### Sesión 144 — O-ajuste-cierre (H1), C-intercambiar-instancias: **EL AJUSTE MANUAL PERSISTE SOBRE EL CENTRO REAL, Y LO CERTIFICA UN ENDPOINT QUE NO ES EL QUE HIZO EL CAMBIO.** El M0 reescribió la condición (1) sobre el INTERCAMBIO y puso una puerta de medición delante en vez de fiarse del argumento: 10 678 pares candidatos barridos sobre el centro real, **1 774 válidos** y 979 no degenerados, antes de escribir una línea de producto. El intercambio salió 200, `GET /diagnostico` devolvió **cero violaciones duras** después, y la vuelta dejó el fichero con **2 bytes de diferencia**, los dos de la cabecera SQLite. app 317 -> 334.
- L782 — ### Bloques de Fase 2
- L790 — ### Bloques de Fase 5
- L813 — ### Bloques de Fase 6
- L858 — ### Bloques de Fase 8
- L1067 — ### Fases completadas
- L1171 — ### Cierre del modelo — Sesión 8
- L1219 — ### Decisiones permanentes (no reabrir sin razón de peso)
- L1265 — ### Método de trabajo (procedimiento vigente)
- L1298 — ### Deuda consciente VIVA
- L3020 — ### Deuda consciente CERRADA (histórico)
- L3118 — ### Notas técnicas validadas en Fase 0
- L3128 — ### Notas técnicas validadas en Fase 6
- L3162 — ### Por qué OR-Tools sobre Timefold (no reabrir)
- L3171 — ### Hallazgos del análisis de PDFs (datos reales del centro)
- L3198 — ### Registro detallado de sesiones S10–S31
- L3207 — ## Señales globales de alerta
