...
- L699 — ### Sesión 138 — O-particiones (H2): **LAS CUATRO PREGUNTAS DE DOMINIO SE CIERRAN POR MEDICIÓN Y NINGUNA ERA PARA EL JEFE DE ESTUDIOS. El objetivo se reduce a la mitad: `Particion` NO hay que materializarla, porque el mecanismo de mezcla ya existe en `plaza_subgrupo` y expresa más que la plantilla que `D1` proponía.** Se reescribe el «Terminado cuando», que era inalcanzable tal como estaba redactado. Sesión de MEDICIÓN en tres pasadas de solo lectura: ni una fila escrita en ninguna base. Nacen cuatro deudas y ninguna abre sesión. Ni un fichero de `app/`, `solver/` ni `app/frontend/` tocado.
- L770 — ### Bloques de Fase 2
- L778 — ### Bloques de Fase 5
- L801 — ### Bloques de Fase 6
- L846 — ### Bloques de Fase 8
- L1055 — ### Fases completadas
- L1159 — ### Cierre del modelo — Sesión 8
- L1207 — ### Decisiones permanentes (no reabrir sin razón de peso)
- L1253 — ### Método de trabajo (procedimiento vigente)
- L1286 — ### Deuda consciente VIVA
- L2992 — ### Deuda consciente CERRADA (histórico)
- L3090 — ### Notas técnicas validadas en Fase 0
- L3100 — ### Notas técnicas validadas en Fase 6
- L3134 — ### Por qué OR-Tools sobre Timefold (no reabrir)
- L3143 — ### Hallazgos del análisis de PDFs (datos reales del centro)
- L3170 — ### Registro detallado de sesiones S10–S31
- L3179 — ## Señales globales de alerta
