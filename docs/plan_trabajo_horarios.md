...
### Sesión 168 — O-aceptación (H4), C-alcance-aceptacion: **H4 ABRE SU TERCER OBJETIVO, `O-aceptación`, CON EL CRITERIO ESCRITO SOBRE MEDICIÓN: 0 DE 4.** La cadena entera de §1 tenía nombre pero no tenía hito ni ficha. La medición encuentra que los pasos 2, 3 y 4 no se han ejecutado nunca en el bundle de Windows, y que el oráculo de exportación da OK sobre un PDF que pinta una clase de dos horas como si fuera de una.
  ...
  DECISIONES (usuario, a propuesta del arquitecto), en la ficha: (D1) centro de aceptación nuevo, pequeño y versionado. (D2) Opción B: el guion incluye una actividad de 2 tramos y `D-proyeccion-sin-duracion` pasa a bloquear; se descarta declararlo como limitación. (D3) Los oráculos se usan tal cual, y el de exportación aprende la duración. (D4) Tres deudas quedan fuera del criterio. (D5) El primer Cambio es generar en el bundle de Windows. (D6) Un fallo repite la cadena entera, y la corrida válida deja acta.
  ...
  DEFECTOS DE INSTRUMENTO. (1) Del asistente: el texto del alta contaba como hallazgos nuevos dos deudas vivas desde S107 (`D-jornada-msg409` y `D-jornada-asimetria`); se corrigió antes del commit. (2) Del asistente: el guion de la fase 3 decía «PARA» ante un ancla repetida y, a la vez, daba la regla para desambiguarla. Claude Code siguió la regla y lo informó, sin daño.
...
- **D-proyeccion-sin-duracion** (S148, VIVA, TÉCNICA REAL, BLOQUEANTE desde S168, sede `O-aceptación`, condición 3) — LA
  ...
  en navegador no se midió; se toma de S167. Pasa a bloquear la condición 3 de `O-aceptación` por la decisión D2
...
- **D-verificar-cierre-ciego-a-las-tablas** (S168, VIVA, TÉCNICA REAL, no bloqueante, sede Higiene/Método) — UNA FILA DE TABLA
  ...
  su cabecera, contando también las barras dentro de código en línea.
