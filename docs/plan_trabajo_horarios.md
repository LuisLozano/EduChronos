...
- L742 — ### Sesión 153 — O-instalación (H4), C-datos-usuario: **LA BASE DEJA DE NACER JUNTO AL PROGRAMA Y SE MUDA A LA CARPETA DE DATOS DEL USUARIO.** `O-instalación` pasa de 2 a **3 de 9**: la condición 7 queda cumplida y verificada en las dos plataformas, con el dato sobreviviendo a lanzar desde dos directorios y a sustituir la carpeta del programa. Las condiciones 1 y 2 se RE-VERIFICAN sobre el bundle nuevo, que crece 4.083 B. Lo más valioso de la sesión no es el producto sino el M3: el mutante PORTANTE deja la suite VERDE.
- L812 — ### Bloques de Fase 2
- L820 — ### Bloques de Fase 5
- L843 — ### Bloques de Fase 6
- L888 — ### Bloques de Fase 8
- L1097 — ### Fases completadas
- L1201 — ### Cierre del modelo — Sesión 8
- L1249 — ### Decisiones permanentes (no reabrir sin razón de peso)
- L1295 — ### Método de trabajo (procedimiento vigente)
- L1328 — ### Deuda consciente VIVA
- L3180 — ### Deuda consciente CERRADA (histórico)
- L3279 — ### Notas técnicas validadas en Fase 0
- L3292 — ### Notas técnicas validadas en Fase 6
- L3337 — ### Notas técnicas validadas en Fase 9
- L3346 — ### Notas técnicas validadas en Fase 11
- L3419 — ### Por qué OR-Tools sobre Timefold (no reabrir)
- L3428 — ### Hallazgos del análisis de PDFs (datos reales del centro)
- L3455 — ### Registro detallado de sesiones S10–S31
- L3464 — ## Señales globales de alerta
...
### Sesión 153 — O-instalación (H4), C-datos-usuario: **LA BASE DEJA DE NACER JUNTO AL PROGRAMA Y SE MUDA A LA CARPETA DE DATOS DEL USUARIO.** `O-instalación` pasa de 2 a **3 de 9**: la condición 7 queda cumplida y verificada en las dos plataformas, con el dato sobreviviendo a lanzar desde dos directorios y a sustituir la carpeta del programa. Las condiciones 1 y 2 se RE-VERIFICAN sobre el bundle nuevo, que crece 4.083 B. Lo más valioso de la sesión no es el producto sino el M3: el mutante PORTANTE deja la suite VERDE.
