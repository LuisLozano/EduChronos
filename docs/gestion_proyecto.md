...
- L1876 — ## 4. Clasificación del trabajo pendiente
- L1894 — ### Clasificación de las deudas vivas actuales
- L1900 — #### Objetivos disfrazados de deuda → se PROMUEVEN a objetivo (§3)
- L1907 — #### Deuda técnica real, colgada de su objetivo
- L2009 — #### Mejora futura, cuelga y espera
- L2045 — #### Decisión arquitectónica consciente → sale de la cola
- L2058 — #### Limitación conocida → sale de la cola, se documenta el "no se hará"
- L2069 — #### Deuda de MÉTODO → se integra en `metodo.md`, no en el producto
- L2078 — #### Deuda ya CERRADA (histórico, no pendiente)
- L2145 — ## 5. Revisión del roadmap: por qué H2 va primero
- L2210 — ## 6. Reglas estratégicas
- L2270 — ## 7. Métricas del sistema
- L2291 — ## 8. El sistema respondiendo a las preguntas clave
...
- **Decisiones (S158, del usuario salvo la F, que sale de medir):** (A) Los pines NO pasan al curso nuevo: son
  ...
  sobrevive a reconstruir el contexto. (F) El solo lectura lo impone la aplicación, porque el de fichero no
...
- **Cambios que agrupa:** `C-alcance-curso` ✔ HECHO (S158): el M0, las seis mediciones y este criterio.
  ...
  `CURSO_SOLO_LECTURA`). Las mitades de interfaz de 1, 3 y 6 pasan al Cambio del selector (5).
