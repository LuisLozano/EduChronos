...
- L1884 — ## 4. Clasificación del trabajo pendiente
- L1902 — ### Clasificación de las deudas vivas actuales
- L1908 — #### Objetivos disfrazados de deuda → se PROMUEVEN a objetivo (§3)
- L1915 — #### Deuda técnica real, colgada de su objetivo
- L2018 — #### Mejora futura, cuelga y espera
- L2056 — #### Decisión arquitectónica consciente → sale de la cola
- L2069 — #### Limitación conocida → sale de la cola, se documenta el "no se hará"
- L2080 — #### Deuda de MÉTODO → se integra en `metodo.md`, no en el producto
- L2089 — #### Deuda ya CERRADA (histórico, no pendiente)
- L2156 — ## 5. Revisión del roadmap: por qué H2 va primero
- L2221 — ## 6. Reglas estratégicas
- L2281 — ## 7. Métricas del sistema
- L2302 — ## 8. El sistema respondiendo a las preguntas clave
...
- **Deudas que pasan a bloquear:** `D-horario-id-a-fuego` (condición 4) y `D-e2e-aislamiento` (condición 8).
  ...
  duplicación no copia horarios ni pines; y `D-e2e-centro-minimo-rojo`, por la decisión C. **SALDADA en S161:** `D-horario-id-a-fuego`. Sólo queda bloqueando `D-e2e-aislamiento`.
