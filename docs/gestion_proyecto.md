...
- L1967 — #### Mejora futura, cuelga y espera
- L2003 — #### Decisión arquitectónica consciente → sale de la cola
- L2016 — #### Limitación conocida → sale de la cola, se documenta el "no se hará"
- L2027 — #### Deuda de MÉTODO → se integra en `metodo.md`, no en el producto
- L2036 — #### Deuda ya CERRADA (histórico, no pendiente)
- L2103 — ## 5. Revisión del roadmap: por qué H2 va primero
- L2168 — ## 6. Reglas estratégicas
- L2228 — ## 7. Métricas del sistema
- L2249 — ## 8. El sistema respondiendo a las preguntas clave
