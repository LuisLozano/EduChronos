...
- L1866 — ## 4. Clasificación del trabajo pendiente
- L1884 — ### Clasificación de las deudas vivas actuales
- L1890 — #### Objetivos disfrazados de deuda → se PROMUEVEN a objetivo (§3)
- L1897 — #### Deuda técnica real, colgada de su objetivo
- L1998 — #### Mejora futura, cuelga y espera
- L2034 — #### Decisión arquitectónica consciente → sale de la cola
- L2047 — #### Limitación conocida → sale de la cola, se documenta el "no se hará"
- L2058 — #### Deuda de MÉTODO → se integra en `metodo.md`, no en el producto
- L2067 — #### Deuda ya CERRADA (histórico, no pendiente)
- L2134 — ## 5. Revisión del roadmap: por qué H2 va primero
- L2199 — ## 6. Reglas estratégicas
- L2259 — ## 7. Métricas del sistema
- L2280 — ## 8. El sistema respondiendo a las preguntas clave
...
- **Cambios que agrupa:** `C-alcance-curso` ✔ HECHO (S158): el M0, las seis mediciones y este criterio.
  ...
  selector y cambio de contexto (5); horario vigente del curso (4); e2e (8); Windows (9).
