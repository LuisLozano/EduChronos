...
- L2172 — #### Mejora futura, cuelga y espera
- L2212 — #### Decisión arquitectónica consciente → sale de la cola
- L2225 — #### Limitación conocida → sale de la cola, se documenta el "no se hará"
- L2236 — #### Deuda de MÉTODO → se integra en `metodo.md`, no en el producto
- L2245 — #### Deuda ya CERRADA (histórico, no pendiente)
- L2312 — ## 5. Revisión del roadmap: por qué H2 va primero
- L2377 — ## 6. Reglas estratégicas
- L2437 — ## 7. Métricas del sistema
- L2458 — ## 8. El sistema respondiendo a las preguntas clave
...
- **Cambios que agrupa:** `C-alcance-aceptacion` ✔ HECHO (S168): el M0, el M2 y este criterio.
  ...
  `C-exportacion-bloques` ✔ HECHO (S170): condición 3, en cuatro fases (oráculo, backend, rejilla y M4). Agrupación orientativa del resto, NO decidida: guion (1); corrida (4).
- **Métrica de §7:** si pasa de ocho sesiones, esconde dos objetivos.
