...
- L959 — #### O-diseño — "La aplicación tiene un aspecto cuidado y coherente." ✔ TERMINADO (S133)
- L1250 — #### O-navegación — "La aplicación se maneja como una aplicación de escritorio." ✔ TERMINADO (S127)
- L1442 — ## 4. Clasificación del trabajo pendiente
- L1460 — ### Clasificación de las deudas vivas actuales
- L1466 — #### Objetivos disfrazados de deuda → se PROMUEVEN a objetivo (§3)
- L1473 — #### Deuda técnica real, colgada de su objetivo
- L1555 — #### Mejora futura, cuelga y espera
- L1586 — #### Decisión arquitectónica consciente → sale de la cola
- L1598 — #### Limitación conocida → sale de la cola, se documenta el "no se hará"
- L1607 — #### Deuda de MÉTODO → se integra en `metodo.md`, no en el producto
- L1614 — #### Deuda ya CERRADA (histórico, no pendiente)
- L1681 — ## 5. Revisión del roadmap: por qué H2 va primero
- L1746 — ## 6. Reglas estratégicas
- L1793 — ## 7. Métricas del sistema
- L1814 — ## 8. El sistema respondiendo a las preguntas clave
...
- **Terminado cuando** — REESCRITO en S142 sobre medición (precedente de forma y
  ...
  2. Al intentarlo sobre un tramo que viola una regla dura, la interfaz **nombra el
     recurso concreto** que la causa. El veredicto lo emite el SERVIDOR; la rejilla
     ...
     **PRECISIÓN PENDIENTE, medida en el M4 de S144 y no anticipada aquí:**
