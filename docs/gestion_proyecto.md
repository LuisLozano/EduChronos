...
- **Cambios que agrupa** (nombrados en el M0 de S115; la ficha no los tenía, y crearlos fue
  ...
  - **C-generación** — EN CURSO (S117, primera parte). Solve sobre el IES real: factibilidad, tiempo y contraste con el
