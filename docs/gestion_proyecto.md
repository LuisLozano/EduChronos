...
- L963 — ### H1 — Ajustar (cierre)
- L965 — #### O-ajuste-cierre — "El ajuste manual está completo y verificado." ✔ TERMINADO (S146)
- L1142 — #### O-diseño — "La aplicación tiene un aspecto cuidado y coherente." ✔ TERMINADO (S133)
- L1433 — #### O-navegación — "La aplicación se maneja como una aplicación de escritorio." ✔ TERMINADO (S127)
- L1623 — ### H3 — Exportar
- L1625 — #### O-exportación — "El horario sale de la aplicación, en papel y en datos." ✔ TERMINADO (S150)
- L1686 — ### H4 — Instalar y pasar de curso
- L1688 — #### O-instalación — "La aplicación se instala, arranca y se cierra en un Windows limpio sin ayuda técnica." ✔ TERMINADO (S156)
- L1862 — #### O-curso — "El centro empieza el curso siguiente sin perder el anterior." ✔ TERMINADO (S163)
- L1959 — ## 4. Clasificación del trabajo pendiente
- L1977 — ### Clasificación de las deudas vivas actuales
- L1983 — #### Objetivos disfrazados de deuda → se PROMUEVEN a objetivo (§3)
- L1990 — #### Deuda técnica real, colgada de su objetivo
- L2099 — #### Mejora futura, cuelga y espera
- L2137 — #### Decisión arquitectónica consciente → sale de la cola
- L2150 — #### Limitación conocida → sale de la cola, se documenta el "no se hará"
- L2161 — #### Deuda de MÉTODO → se integra en `metodo.md`, no en el producto
- L2170 — #### Deuda ya CERRADA (histórico, no pendiente)
- L2237 — ## 5. Revisión del roadmap: por qué H2 va primero
- L2302 — ## 6. Reglas estratégicas
- L2362 — ## 7. Métricas del sistema
- L2383 — ## 8. El sistema respondiendo a las preguntas clave
...
- **Cambios:** `C-alcance-disponibilidad` ✔ HECHO (S164, este criterio). `C-dura-completa` EN CURSO (S165): regla `INDISPONIBILIDAD_PROFESOR` y BLANDA
  ...
  y `PIN_SOBRE_TRAMO_DURA` en la prevalidación; le falta el solver (la 5: vetar y penalizar todos los tramos ocupados) y medir
  el cuerpo HTTP del 422 de la 6.
