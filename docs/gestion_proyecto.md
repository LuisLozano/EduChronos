...
- L1697 — ## 4. Clasificación del trabajo pendiente
- L1715 — ### Clasificación de las deudas vivas actuales
- L1721 — #### Objetivos disfrazados de deuda → se PROMUEVEN a objetivo (§3)
- L1728 — #### Deuda técnica real, colgada de su objetivo
- L1821 — #### Mejora futura, cuelga y espera
- L1855 — #### Decisión arquitectónica consciente → sale de la cola
- L1867 — #### Limitación conocida → sale de la cola, se documenta el "no se hará"
- L1876 — #### Deuda de MÉTODO → se integra en `metodo.md`, no en el producto
- L1884 — #### Deuda ya CERRADA (histórico, no pendiente)
- L1951 — ## 5. Revisión del roadmap: por qué H2 va primero
- L2016 — ## 6. Reglas estratégicas
- L2075 — ## 7. Métricas del sistema
- L2096 — ## 8. El sistema respondiendo a las preguntas clave
...
- **Terminado cuando** — ESCRITO en S151 sobre medición: M2 en Linux (clon limpio y
  ...
  7. **Datos del usuario.** La base vive en una carpeta del usuario que no depende de desde
     dónde se lance ni de dónde esté el programa: lanzar desde dos sitios usa la misma base,
     y sustituir la carpeta del programa por otra versión no pierde datos. Hoy se crea en el
     directorio de trabajo, que con doble clic es la carpeta del programa; en S151 una copia
     por USB se llevó la base dentro. Es la decisión de la que depende la Fase 10.
...
- **Cambios que agrupa:** `C-alcance-instalacion` ✔ HECHO (S151), el M0 y las mediciones
  ...
  guiones de empaquetado, `docs/empaquetado.md` y las condiciones 1 y 2. Los demás se deciden en sus M0. Agrupación orientativa,
...
- **Decisiones que quedan para sus Cambios:** el medio de entrega y la firma del
  ...
  bandeja del sistema es candidato); la carpeta de datos. **CORREGIDO en S152:** este
