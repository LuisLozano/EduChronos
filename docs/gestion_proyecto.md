...
- L748 — #### O-particiones — "Un grupo nuevo entra en el curso sin reconfigurar a mano." (ESBOZADO S115)
- L781 — ### H1 — Ajustar (cierre)
- L783 — #### O-ajuste-cierre — "El ajuste manual está completo y verificado."
- L797 — #### O-diseño — "La aplicación tiene un aspecto cuidado y coherente." ✔ TERMINADO (S133)
- L1088 — #### O-navegación — "La aplicación se maneja como una aplicación de escritorio." ✔ TERMINADO (S127)
- L1280 — ## 4. Clasificación del trabajo pendiente
- L1298 — ### Clasificación de las deudas vivas actuales
- L1304 — #### Objetivos disfrazados de deuda → se PROMUEVEN a objetivo (§3)
- L1311 — #### Deuda técnica real, colgada de su objetivo
- L1377 — #### Mejora futura, cuelga y espera
- L1409 — #### Decisión arquitectónica consciente → sale de la cola
- L1421 — #### Limitación conocida → sale de la cola, se documenta el "no se hará"
- L1430 — #### Deuda de MÉTODO → se integra en `metodo.md`, no en el producto
- L1437 — #### Deuda ya CERRADA (histórico, no pendiente)
- L1496 — ## 5. Revisión del roadmap: por qué H2 va primero
- L1550 — ## 6. Reglas estratégicas
- L1597 — ## 7. Métricas del sistema
- L1618 — ## 8. El sistema respondiendo a las preguntas clave
