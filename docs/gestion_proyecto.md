...
- L859 — #### O-ajuste-cierre — "El ajuste manual está completo y verificado."
- L1011 — #### O-diseño — "La aplicación tiene un aspecto cuidado y coherente." ✔ TERMINADO (S133)
- L1302 — #### O-navegación — "La aplicación se maneja como una aplicación de escritorio." ✔ TERMINADO (S127)
- L1494 — ## 4. Clasificación del trabajo pendiente
- L1512 — ### Clasificación de las deudas vivas actuales
- L1518 — #### Objetivos disfrazados de deuda → se PROMUEVEN a objetivo (§3)
- L1525 — #### Deuda técnica real, colgada de su objetivo
- L1609 — #### Mejora futura, cuelga y espera
- L1642 — #### Decisión arquitectónica consciente → sale de la cola
- L1654 — #### Limitación conocida → sale de la cola, se documenta el "no se hará"
- L1663 — #### Deuda de MÉTODO → se integra en `metodo.md`, no en el producto
- L1670 — #### Deuda ya CERRADA (histórico, no pendiente)
- L1737 — ## 5. Revisión del roadmap: por qué H2 va primero
- L1802 — ## 6. Reglas estratégicas
- L1849 — ## 7. Métricas del sistema
- L1870 — ## 8. El sistema respondiendo a las preguntas clave
