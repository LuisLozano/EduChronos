...
- L2029 — ## 4. Clasificación del trabajo pendiente
- L2047 — ### Clasificación de las deudas vivas actuales
- L2053 — #### Objetivos disfrazados de deuda → se PROMUEVEN a objetivo (§3)
- L2060 — #### Deuda técnica real, colgada de su objetivo
- L2173 — #### Mejora futura, cuelga y espera
- L2213 — #### Decisión arquitectónica consciente → sale de la cola
- L2226 — #### Limitación conocida → sale de la cola, se documenta el "no se hará"
- L2237 — #### Deuda de MÉTODO → se integra en `metodo.md`, no en el producto
- L2246 — #### Deuda ya CERRADA (histórico, no pendiente)
- L2313 — ## 5. Revisión del roadmap: por qué H2 va primero
- L2378 — ## 6. Reglas estratégicas
- L2438 — ## 7. Métricas del sistema
- L2459 — ## 8. El sistema respondiendo a las preguntas clave
...
- **Cambios que agrupa:** `C-alcance-aceptacion` ✔ HECHO (S168): el M0, el M2 y este criterio.
  ...
  Agrupación orientativa del resto, NO decidida: guion (1); corrida (4).
- **Métrica de §7:** si pasa de ocho sesiones, esconde dos objetivos.
