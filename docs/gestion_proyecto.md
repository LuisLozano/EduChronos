...
- L1757 — ## 4. Clasificación del trabajo pendiente
- L1775 — ### Clasificación de las deudas vivas actuales
- L1781 — #### Objetivos disfrazados de deuda → se PROMUEVEN a objetivo (§3)
- L1788 — #### Deuda técnica real, colgada de su objetivo
- L1886 — #### Mejora futura, cuelga y espera
- L1921 — #### Decisión arquitectónica consciente → sale de la cola
- L1933 — #### Limitación conocida → sale de la cola, se documenta el "no se hará"
- L1943 — #### Deuda de MÉTODO → se integra en `metodo.md`, no en el producto
- L1951 — #### Deuda ya CERRADA (histórico, no pendiente)
- L2018 — ## 5. Revisión del roadmap: por qué H2 va primero
- L2083 — ## 6. Reglas estratégicas
- L2142 — ## 7. Métricas del sistema
- L2163 — ## 8. El sistema respondiendo a las preguntas clave
