...
- L873 — #### O-diseño — "La aplicación tiene un aspecto cuidado y coherente." ✔ TERMINADO (S133)
- L1164 — #### O-navegación — "La aplicación se maneja como una aplicación de escritorio." ✔ TERMINADO (S127)
- L1356 — ## 4. Clasificación del trabajo pendiente
- L1374 — ### Clasificación de las deudas vivas actuales
- L1380 — #### Objetivos disfrazados de deuda → se PROMUEVEN a objetivo (§3)
- L1387 — #### Deuda técnica real, colgada de su objetivo
- L1463 — #### Mejora futura, cuelga y espera
- L1495 — #### Decisión arquitectónica consciente → sale de la cola
- L1507 — #### Limitación conocida → sale de la cola, se documenta el "no se hará"
- L1516 — #### Deuda de MÉTODO → se integra en `metodo.md`, no en el producto
- L1523 — #### Deuda ya CERRADA (histórico, no pendiente)
- L1582 — ## 5. Revisión del roadmap: por qué H2 va primero
- L1636 — ## 6. Reglas estratégicas
- L1683 — ## 7. Métricas del sistema
- L1704 — ## 8. El sistema respondiendo a las preguntas clave
