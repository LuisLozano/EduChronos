...
- L773 — #### O-diseño — "La aplicación tiene un aspecto cuidado y coherente." ✔ TERMINADO (S133)
- L1064 — #### O-navegación — "La aplicación se maneja como una aplicación de escritorio." ✔ TERMINADO (S127)
- L1256 — ## 4. Clasificación del trabajo pendiente
- L1274 — ### Clasificación de las deudas vivas actuales
- L1280 — #### Objetivos disfrazados de deuda → se PROMUEVEN a objetivo (§3)
- L1287 — #### Deuda técnica real, colgada de su objetivo
- L1341 — #### Mejora futura, cuelga y espera
- L1373 — #### Decisión arquitectónica consciente → sale de la cola
- L1385 — #### Limitación conocida → sale de la cola, se documenta el "no se hará"
- L1394 — #### Deuda de MÉTODO → se integra en `metodo.md`, no en el producto
- L1401 — #### Deuda ya CERRADA (histórico, no pendiente)
- L1461 — ## 5. Revisión del roadmap: por qué H2 va primero
- L1515 — ## 6. Reglas estratégicas
- L1562 — ## 7. Métricas del sistema
- L1583 — ## 8. El sistema respondiendo a las preguntas clave
