...
- L849 — ### H1 — Ajustar (cierre)
- L851 — #### O-ajuste-cierre — "El ajuste manual está completo y verificado."
- L865 — #### O-diseño — "La aplicación tiene un aspecto cuidado y coherente." ✔ TERMINADO (S133)
- L1156 — #### O-navegación — "La aplicación se maneja como una aplicación de escritorio." ✔ TERMINADO (S127)
- L1348 — ## 4. Clasificación del trabajo pendiente
- L1366 — ### Clasificación de las deudas vivas actuales
- L1372 — #### Objetivos disfrazados de deuda → se PROMUEVEN a objetivo (§3)
- L1379 — #### Deuda técnica real, colgada de su objetivo
- L1452 — #### Mejora futura, cuelga y espera
- L1484 — #### Decisión arquitectónica consciente → sale de la cola
- L1496 — #### Limitación conocida → sale de la cola, se documenta el "no se hará"
- L1505 — #### Deuda de MÉTODO → se integra en `metodo.md`, no en el producto
- L1512 — #### Deuda ya CERRADA (histórico, no pendiente)
- L1571 — ## 5. Revisión del roadmap: por qué H2 va primero
- L1625 — ## 6. Reglas estratégicas
- L1672 — ## 7. Métricas del sistema
- L1693 — ## 8. El sistema respondiendo a las preguntas clave
