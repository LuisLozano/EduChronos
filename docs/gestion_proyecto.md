...
- L1587 — #### O-instalación — "La aplicación se instala, arranca y se cierra en un Windows limpio sin ayuda técnica." ✔ TERMINADO (S156)
- L1763 — ## 4. Clasificación del trabajo pendiente
- L1781 — ### Clasificación de las deudas vivas actuales
- L1787 — #### Objetivos disfrazados de deuda → se PROMUEVEN a objetivo (§3)
- L1794 — #### Deuda técnica real, colgada de su objetivo
- L1892 — #### Mejora futura, cuelga y espera
- L1928 — #### Decisión arquitectónica consciente → sale de la cola
- L1941 — #### Limitación conocida → sale de la cola, se documenta el "no se hará"
- L1952 — #### Deuda de MÉTODO → se integra en `metodo.md`, no en el producto
- L1960 — #### Deuda ya CERRADA (histórico, no pendiente)
- L2027 — ## 5. Revisión del roadmap: por qué H2 va primero
- L2092 — ## 6. Reglas estratégicas
- L2151 — ## 7. Métricas del sistema
- L2172 — ## 8. El sistema respondiendo a las preguntas clave
