...
- L1042 — #### O-navegación — "La aplicación se maneja como una aplicación de escritorio." ✔ TERMINADO (S127)
- L1234 — ## 4. Clasificación del trabajo pendiente
- L1252 — ### Clasificación de las deudas vivas actuales
- L1258 — #### Objetivos disfrazados de deuda → se PROMUEVEN a objetivo (§3)
- L1265 — #### Deuda técnica real, colgada de su objetivo
- L1319 — #### Mejora futura, cuelga y espera
- L1349 — #### Decisión arquitectónica consciente → sale de la cola
- L1361 — #### Limitación conocida → sale de la cola, se documenta el "no se hará"
- L1370 — #### Deuda de MÉTODO → se integra en `metodo.md`, no en el producto
- L1377 — #### Deuda ya CERRADA (histórico, no pendiente)
- L1437 — ## 5. Revisión del roadmap: por qué H2 va primero
- L1491 — ## 6. Reglas estratégicas
- L1538 — ## 7. Métricas del sistema
- L1559 — ## 8. El sistema respondiendo a las preguntas clave
