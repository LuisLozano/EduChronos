...
- L1587 — ## 4. Clasificación del trabajo pendiente
- L1605 — ### Clasificación de las deudas vivas actuales
- L1611 — #### Objetivos disfrazados de deuda → se PROMUEVEN a objetivo (§3)
- L1618 — #### Deuda técnica real, colgada de su objetivo
- L1708 — #### Mejora futura, cuelga y espera
- L1742 — #### Decisión arquitectónica consciente → sale de la cola
- L1754 — #### Limitación conocida → sale de la cola, se documenta el "no se hará"
- L1763 — #### Deuda de MÉTODO → se integra en `metodo.md`, no en el producto
- L1770 — #### Deuda ya CERRADA (histórico, no pendiente)
- L1837 — ## 5. Revisión del roadmap: por qué H2 va primero
- L1902 — ## 6. Reglas estratégicas
- L1949 — ## 7. Métricas del sistema
- L1970 — ## 8. El sistema respondiendo a las preguntas clave
