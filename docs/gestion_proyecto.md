...
- L890 — ### H1 — Ajustar (cierre)
- L892 — #### O-ajuste-cierre — "El ajuste manual está completo y verificado." ✔ TERMINADO (S146)
- L1069 — #### O-diseño — "La aplicación tiene un aspecto cuidado y coherente." ✔ TERMINADO (S133)
- L1360 — #### O-navegación — "La aplicación se maneja como una aplicación de escritorio." ✔ TERMINADO (S127)
- L1550 — ### H3 — Exportar
- L1552 — #### O-exportación — "El horario sale de la aplicación, en papel y en datos." ✔ TERMINADO (S150)
- L1613 — ### H4 — Instalar y pasar de curso
- L1615 — #### O-instalación — "La aplicación se instala, arranca y se cierra en un Windows limpio sin ayuda técnica." ✔ TERMINADO (S156)
- L1789 — #### O-curso — "El centro empieza el curso siguiente sin perder el anterior."
- L1883 — ## 4. Clasificación del trabajo pendiente
- L1901 — ### Clasificación de las deudas vivas actuales
- L1907 — #### Objetivos disfrazados de deuda → se PROMUEVEN a objetivo (§3)
- L1914 — #### Deuda técnica real, colgada de su objetivo
- L2017 — #### Mejora futura, cuelga y espera
- L2054 — #### Decisión arquitectónica consciente → sale de la cola
- L2067 — #### Limitación conocida → sale de la cola, se documenta el "no se hará"
- L2078 — #### Deuda de MÉTODO → se integra en `metodo.md`, no en el producto
- L2087 — #### Deuda ya CERRADA (histórico, no pendiente)
- L2154 — ## 5. Revisión del roadmap: por qué H2 va primero
- L2219 — ## 6. Reglas estratégicas
- L2279 — ## 7. Métricas del sistema
- L2300 — ## 8. El sistema respondiendo a las preguntas clave
...
- **Dependencia externa:** los datos reales de indisponibilidad sólo los tiene el centro. Conviene pedirlos al
  jefe de estudios antes de abrir (precedente: los tutores, S134).
...
- **Deudas que pasan a bloquear:** `D-horario-id-a-fuego` (condición 4) y `D-e2e-aislamiento` (condición 8).
  ...
  duplicación no copia horarios ni pines; y `D-e2e-centro-minimo-rojo`, por la decisión C.
...
- **Cambios que agrupa:** `C-alcance-curso` ✔ HECHO (S158): el M0, las seis mediciones y este criterio.
  ...
  lectura, y diálogo de cursos. Cumple la 1, la 3, la 5 y la 6.
