...
- L1961 — #### Deuda ya CERRADA (histórico, no pendiente)
- L2028 — ## 5. Revisión del roadmap: por qué H2 va primero
- L2093 — ## 6. Reglas estratégicas
- L2153 — ## 7. Métricas del sistema
- L2174 — ## 8. El sistema respondiendo a las preguntas clave
