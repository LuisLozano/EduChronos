...
- L865 — #### O-disponibilidad — "El centro introduce la disponibilidad de su profesorado." ✔ TERMINADO (S167)
- L964 — ### H1 — Ajustar (cierre)
- L966 — #### O-ajuste-cierre — "El ajuste manual está completo y verificado." ✔ TERMINADO (S146)
- L1143 — #### O-diseño — "La aplicación tiene un aspecto cuidado y coherente." ✔ TERMINADO (S133)
- L1434 — #### O-navegación — "La aplicación se maneja como una aplicación de escritorio." ✔ TERMINADO (S127)
- L1624 — ### H3 — Exportar
- L1626 — #### O-exportación — "El horario sale de la aplicación, en papel y en datos." ✔ TERMINADO (S150)
- L1687 — ### H4 — Instalar y pasar de curso
- L1689 — #### O-instalación — "La aplicación se instala, arranca y se cierra en un Windows limpio sin ayuda técnica." ✔ TERMINADO (S156)
- L1863 — #### O-curso — "El centro empieza el curso siguiente sin perder el anterior." ✔ TERMINADO (S163)
- L1960 — ## 4. Clasificación del trabajo pendiente
- L1978 — ### Clasificación de las deudas vivas actuales
- L1984 — #### Objetivos disfrazados de deuda → se PROMUEVEN a objetivo (§3)
- L1991 — #### Deuda técnica real, colgada de su objetivo
- L2102 — #### Mejora futura, cuelga y espera
- L2142 — #### Decisión arquitectónica consciente → sale de la cola
- L2155 — #### Limitación conocida → sale de la cola, se documenta el "no se hará"
- L2166 — #### Deuda de MÉTODO → se integra en `metodo.md`, no en el producto
- L2175 — #### Deuda ya CERRADA (histórico, no pendiente)
- L2242 — ## 5. Revisión del roadmap: por qué H2 va primero
- L2307 — ## 6. Reglas estratégicas
- L2367 — ## 7. Métricas del sistema
- L2388 — ## 8. El sistema respondiendo a las preguntas clave
...
#### O-aceptación — "La cadena entera de §1 pasa en un Windows limpio."
...
- **Terminado cuando** — ESCRITO en S168 sobre esa medición. O-aceptación termina cuando:
  ...
  4. **Cadena.** Un humano ejecuta el guion entero en un Windows 11 limpio con cuenta estándar, sin Java ni
     ...
     bundle, la fecha y el resultado de cada paso.
- **Decisiones (S168, usuario a propuesta del arquitecto):** (D1) El centro de aceptación es nuevo, pequeño
  y versionado; su tamaño lo fija lo que exige el paso 2, no la escala. (D2) El guion incluye una actividad
  ...
  dos horas como si fuera de una contradice «presentable» (S136). (D3) Los oráculos se usan tal cual, salvo
  que el de exportación aprende la duración antes de usarse; la maqueta fija queda fuera del criterio.
  (D4) `D-jornada-congelada-por-disponibilidad`, `D-curso-pestanas-desfasadas` y `D-curso-sin-borrado` quedan
  fuera del criterio y no bloquean. (D5) El primer Cambio es generar en el bundle de Windows, porque es el
  riesgo mayor y menos medido (precedente S151); incluye comprobar que la máquina virtual de S163 construye
  desde HEAD y cuánto mide el bundle. (D6) «Pasa entero»: un fallo se arregla en un Cambio y la cadena se
  repite completa; una corrida válida deja su acta.
...
- **Deudas que pasan a bloquear:** `D-proyeccion-sin-duracion` (condición 3).
...
- **Cambios que agrupa:** `C-alcance-aceptacion` ✔ HECHO (S168): el M0, el M2 y este criterio. Agrupación
  orientativa, NO decidida: generación en el bundle de Windows (2), la primera por D5; exportación con
  bloques (3); guion (1); corrida (4).
- **Métrica de §7:** si pasa de ocho sesiones, esconde dos objetivos.
