...
- L738 — #### O-particiones — "Un grupo nuevo entra en el curso sin reconfigurar a mano." (ESBOZADO S115)
- L771 — ### H1 — Ajustar (cierre)
- L773 — #### O-ajuste-cierre — "El ajuste manual está completo y verificado."
- L786 — #### O-diseño — "La aplicación tiene un aspecto cuidado y coherente." ✔ TERMINADO (S133)
- L1077 — #### O-navegación — "La aplicación se maneja como una aplicación de escritorio." ✔ TERMINADO (S127)
- L1269 — ## 4. Clasificación del trabajo pendiente
- L1287 — ### Clasificación de las deudas vivas actuales
- L1293 — #### Objetivos disfrazados de deuda → se PROMUEVEN a objetivo (§3)
- L1300 — #### Deuda técnica real, colgada de su objetivo
- L1361 — #### Mejora futura, cuelga y espera
- L1393 — #### Decisión arquitectónica consciente → sale de la cola
- L1405 — #### Limitación conocida → sale de la cola, se documenta el "no se hará"
- L1414 — #### Deuda de MÉTODO → se integra en `metodo.md`, no en el producto
- L1421 — #### Deuda ya CERRADA (histórico, no pendiente)
- L1481 — ## 5. Revisión del roadmap: por qué H2 va primero
- L1535 — ## 6. Reglas estratégicas
- L1582 — ## 7. Métricas del sistema
- L1603 — ## 8. El sistema respondiendo a las preguntas clave
...
| D-taller5-inexistente (el aula Taller 5 no está en el catálogo) | O-demo | No | Nace en S134. Alta previa a cargar las 11 actividades de FPB; es trabajo del propio Cambio, no un bloqueo |
| D-fuente-tercera-sin-usar (`Horarios de profesores.pdf` es probablemente mejor fuente que las dos cruzadas en S116) | Sin sede | No | Nace en S134. Trae profesor, asignatura, aula y grupos en la misma celda. Decidir si compensa rederivar; el centro entregó once PDF y ninguno está analizado |
