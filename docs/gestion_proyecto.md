...
- L905 — #### O-diseño — "La aplicación tiene un aspecto cuidado y coherente." ✔ TERMINADO (S133)
- L1196 — #### O-navegación — "La aplicación se maneja como una aplicación de escritorio." ✔ TERMINADO (S127)
- L1388 — ## 4. Clasificación del trabajo pendiente
- L1406 — ### Clasificación de las deudas vivas actuales
- L1412 — #### Objetivos disfrazados de deuda → se PROMUEVEN a objetivo (§3)
- L1419 — #### Deuda técnica real, colgada de su objetivo
- L1498 — #### Mejora futura, cuelga y espera
- L1530 — #### Decisión arquitectónica consciente → sale de la cola
- L1542 — #### Limitación conocida → sale de la cola, se documenta el "no se hará"
- L1551 — #### Deuda de MÉTODO → se integra en `metodo.md`, no en el producto
- L1558 — #### Deuda ya CERRADA (histórico, no pendiente)
- L1617 — ## 5. Revisión del roadmap: por qué H2 va primero
- L1671 — ## 6. Reglas estratégicas
- L1718 — ## 7. Métricas del sistema
- L1739 — ## 8. El sistema respondiendo a las preguntas clave
