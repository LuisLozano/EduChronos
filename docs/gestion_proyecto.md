...
- L1965 — #### Mejora futura, cuelga y espera
- L2001 — #### Decisión arquitectónica consciente → sale de la cola
- L2014 — #### Limitación conocida → sale de la cola, se documenta el "no se hará"
- L2025 — #### Deuda de MÉTODO → se integra en `metodo.md`, no en el producto
- L2034 — #### Deuda ya CERRADA (histórico, no pendiente)
- L2101 — ## 5. Revisión del roadmap: por qué H2 va primero
- L2166 — ## 6. Reglas estratégicas
- L2226 — ## 7. Métricas del sistema
- L2247 — ## 8. El sistema respondiendo a las preguntas clave
