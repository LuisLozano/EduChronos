...
- L63 — ## 1. Estado final del proyecto
- L90 — ## 2. Hitos
- L104 — ### Hitos: valor, dependencias, orden
- L127 — ## 3. Objetivos técnicos
- L138 — ### H2 — Configurar un centro desde cero
- L140 — #### O-shell — "La aplicación es navegable." ✔ TERMINADO (S100)
- L156 — #### O-catálogo — "Creo los elementos simples del centro." ✔ TERMINADO (S106)
- L228 — #### O-estructura — "Expreso la complejidad real del centro." ✔ TERMINADO (S114)
- L478 — #### O-demo — "El centro real funciona de punta a punta." ✔ TERMINADO (S137)
- L765 — #### O-particiones — "Un grupo nuevo entra en el curso sin reconfigurar a mano." ✔ TERMINADO (S141)
- L866 — #### O-disponibilidad — "El centro introduce la disponibilidad de su profesorado." ✔ TERMINADO (S167)
- L965 — ### H1 — Ajustar (cierre)
- L967 — #### O-ajuste-cierre — "El ajuste manual está completo y verificado." ✔ TERMINADO (S146)
- L1144 — #### O-diseño — "La aplicación tiene un aspecto cuidado y coherente." ✔ TERMINADO (S133)
- L1435 — #### O-navegación — "La aplicación se maneja como una aplicación de escritorio." ✔ TERMINADO (S127)
- L1625 — ### H3 — Exportar
- L1627 — #### O-exportación — "El horario sale de la aplicación, en papel y en datos." ✔ TERMINADO (S150)
- L1688 — ### H4 — Instalar y pasar de curso
- L1690 — #### O-instalación — "La aplicación se instala, arranca y se cierra en un Windows limpio sin ayuda técnica." ✔ TERMINADO (S156)
- L1864 — #### O-curso — "El centro empieza el curso siguiente sin perder el anterior." ✔ TERMINADO (S163)
- L1959 — #### O-aceptación — "La cadena entera de §1 pasa en un Windows limpio."
- L2028 — ## 4. Clasificación del trabajo pendiente
- L2046 — ### Clasificación de las deudas vivas actuales
- L2052 — #### Objetivos disfrazados de deuda → se PROMUEVEN a objetivo (§3)
- L2059 — #### Deuda técnica real, colgada de su objetivo
- L2171 — #### Mejora futura, cuelga y espera
- L2211 — #### Decisión arquitectónica consciente → sale de la cola
- L2224 — #### Limitación conocida → sale de la cola, se documenta el "no se hará"
- L2235 — #### Deuda de MÉTODO → se integra en `metodo.md`, no en el producto
- L2244 — #### Deuda ya CERRADA (histórico, no pendiente)
- L2311 — ## 5. Revisión del roadmap: por qué H2 va primero
- L2376 — ## 6. Reglas estratégicas
- L2436 — ## 7. Métricas del sistema
- L2457 — ## 8. El sistema respondiendo a las preguntas clave
