...
- L1520 — ### H3 — Exportar
- L1522 — #### O-exportación — "El horario sale de la aplicación, en papel y en datos." ✔ TERMINADO (S150)
- L1585 — ## 4. Clasificación del trabajo pendiente
- L1603 — ### Clasificación de las deudas vivas actuales
- L1609 — #### Objetivos disfrazados de deuda → se PROMUEVEN a objetivo (§3)
- L1616 — #### Deuda técnica real, colgada de su objetivo
- L1706 — #### Mejora futura, cuelga y espera
- L1740 — #### Decisión arquitectónica consciente → sale de la cola
- L1752 — #### Limitación conocida → sale de la cola, se documenta el "no se hará"
- L1761 — #### Deuda de MÉTODO → se integra en `metodo.md`, no en el producto
- L1768 — #### Deuda ya CERRADA (histórico, no pendiente)
- L1835 — ## 5. Revisión del roadmap: por qué H2 va primero
- L1900 — ## 6. Reglas estratégicas
- L1947 — ## 7. Métricas del sistema
- L1968 — ## 8. El sistema respondiendo a las preguntas clave
