...
- L61 — ## 1. Estado final del proyecto
- L87 — ## 2. Hitos
- L101 — ### Hitos: valor, dependencias, orden
- L124 — ## 3. Objetivos técnicos
- L135 — ### H2 — Configurar un centro desde cero
- L137 — #### O-shell — "La aplicación es navegable." ✔ TERMINADO (S100)
- L153 — #### O-catálogo — "Creo los elementos simples del centro." ✔ TERMINADO (S106)
- L225 — #### O-estructura — "Expreso la complejidad real del centro." ✔ TERMINADO (S114)
- L475 — #### O-demo — "El centro real funciona de punta a punta." ✔ TERMINADO (S137)
- L762 — #### O-particiones — "Un grupo nuevo entra en el curso sin reconfigurar a mano." ✔ TERMINADO (S141)
- L863 — ### H1 — Ajustar (cierre)
- L865 — #### O-ajuste-cierre — "El ajuste manual está completo y verificado." ✔ TERMINADO (S146)
- L1042 — #### O-diseño — "La aplicación tiene un aspecto cuidado y coherente." ✔ TERMINADO (S133)
- L1333 — #### O-navegación — "La aplicación se maneja como una aplicación de escritorio." ✔ TERMINADO (S127)
- L1523 — ### H3 — Exportar
- L1525 — #### O-exportación — "El horario sale de la aplicación, en papel y en datos." ✔ TERMINADO (S150)
- L1586 — ### H4 — Instalar y pasar de curso
- L1588 — #### O-instalación — "La aplicación se instala, arranca y se cierra en un Windows limpio sin ayuda técnica." ✔ TERMINADO (S156)
- L1762 — #### O-curso — "El centro empieza el curso siguiente sin perder el anterior."
- L1836 — ## 4. Clasificación del trabajo pendiente
- L1854 — ### Clasificación de las deudas vivas actuales
- L1860 — #### Objetivos disfrazados de deuda → se PROMUEVEN a objetivo (§3)
- L1867 — #### Deuda técnica real, colgada de su objetivo
- L1968 — #### Mejora futura, cuelga y espera
- L2004 — #### Decisión arquitectónica consciente → sale de la cola
- L2017 — #### Limitación conocida → sale de la cola, se documenta el "no se hará"
- L2028 — #### Deuda de MÉTODO → se integra en `metodo.md`, no en el producto
- L2037 — #### Deuda ya CERRADA (histórico, no pendiente)
- L2104 — ## 5. Revisión del roadmap: por qué H2 va primero
- L2169 — ## 6. Reglas estratégicas
- L2229 — ## 7. Métricas del sistema
- L2250 — ## 8. El sistema respondiendo a las preguntas clave
