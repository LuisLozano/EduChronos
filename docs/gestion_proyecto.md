...
- L1794 — #### O-curso — "El centro empieza el curso siguiente sin perder el anterior." ✔ TERMINADO (S163)
- L1891 — ## 4. Clasificación del trabajo pendiente
- L1909 — ### Clasificación de las deudas vivas actuales
- L1915 — #### Objetivos disfrazados de deuda → se PROMUEVEN a objetivo (§3)
- L1922 — #### Deuda técnica real, colgada de su objetivo
- L2027 — #### Mejora futura, cuelga y espera
- L2065 — #### Decisión arquitectónica consciente → sale de la cola
- L2078 — #### Limitación conocida → sale de la cola, se documenta el "no se hará"
- L2089 — #### Deuda de MÉTODO → se integra en `metodo.md`, no en el producto
- L2098 — #### Deuda ya CERRADA (histórico, no pendiente)
- L2165 — ## 5. Revisión del roadmap: por qué H2 va primero
- L2230 — ## 6. Reglas estratégicas
- L2290 — ## 7. Métricas del sistema
- L2311 — ## 8. El sistema respondiendo a las preguntas clave
