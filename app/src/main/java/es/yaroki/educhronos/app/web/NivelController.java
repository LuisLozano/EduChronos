...
/**
 * Capa REST FINA del CRUD de {@code Nivel} (§4.1, Bloque 8.5-A', réplica del piloto
 * {@code AsignaturaController}). Toda la lógica y la validación viven en
 * {@link NivelService}; el controlador solo enruta y traduce excepciones a códigos
...
public class NivelController {
    ...
    public NivelDTO crear(@RequestBody NivelRequest peticion) {
        try {
    ...
    @PutMapping("/{id}")
    public NivelDTO editar(@PathVariable("id") Long id, @RequestBody NivelRequest peticion) {
        try {
